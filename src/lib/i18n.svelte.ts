...
const en = {
  ...
  "err.accessibility_needed": "Enable Synapse in Accessibility (or remove and re-add it)",
...
const pt: Record<TKey, string> = {
  ...
  "err.accessibility_needed": "Ative o Synapse em Acessibilidade (ou remova e readicione)",
